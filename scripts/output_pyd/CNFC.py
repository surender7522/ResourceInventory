...
#   filename:  CNFC.json
#   timestamp: 2023-04-25T03:55:48+00:00
...
class CNFC(BaseModel):
    ...
    cnfcInstanceId: Optional[str] = None
    cnfcIPPool: Optional[str] = None
    cnfcResourcePool: Optional[str] = None
    cnfcBundleId: Optional[str] = None
    cnfcLabels: Optional[str] = None
