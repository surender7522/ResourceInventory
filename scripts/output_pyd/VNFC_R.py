...
class VNFCR(BaseModel):
    ...
    vnfcInstanceId: Optional[str] = None
    cnfcrIPPool: Optional[str] = None
    cnfcResourcePool: Optional[str] = None
    cnfcrBundleId: Optional[str] = None
    vnfcrLabels: Optional[str] = None
