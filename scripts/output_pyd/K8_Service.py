...
#   filename:  K8_Service.json
#   timestamp: 2023-04-24T11:37:19+00:00
...
class K8Service(BaseModel):
    ...
    k8sType: Optional[str] = None
    k8sServiceClusterIP: Optional[str] = None
    k8sAppname: Optional[str] = None
    k8sTenant: Optional[str] = None
    k8sTenantId: Optional[str] = None
