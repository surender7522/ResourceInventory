...
#   filename:  IPPool.json
#   timestamp: 2023-04-24T11:37:34+00:00
...
class IPPool(BaseModel):
    ...
    ippRanges: Optional[str] = None
    ippPrefix: Optional[str] = None
    ippVLAN: Optional[str] = None
    ippsubnet: Optional[str] = None
    ippDriver: Optional[str] = None
    ippGateway: Optional[str] = None
    ippVFDriver: Optional[str] = None
    availableipscount: Optional[str] = None
    usedipscount: Optional[str] = None
    totalipscount: Optional[str] = None
