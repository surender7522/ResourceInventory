...
#   filename:  User.json
#   timestamp: 2023-04-24T11:37:31+00:00
...
class User(BaseModel):
    ...
    usrFirstname: Optional[str] = None
    usrLastname: Optional[str] = None
    usrName: Optional[str] = None
    usrRoleForTenant: Optional[str] = None
    usrPassword: Optional[str] = None
    usrTenantList: Optional[str] = None
