...
class PhysicalLink(BaseModel):
    connSrcLogicalPort: Optional[str] = None
    connDestLogicalPort: Optional[str] = None
    connSrcEname: Optional[str] = None
    connDestEname: Optional[str] = None
    connSrcPort: Optional[str] = None
    connDestPort: Optional[str] = None
    connLinkId: Optional[str] = None
    connMedium: Optional[str] = None
