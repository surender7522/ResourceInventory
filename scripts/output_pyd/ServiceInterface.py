...
#   filename:  ServiceInterface.json
#   timestamp: 2023-04-24T11:37:37+00:00
...
class ServiceInterface(BaseModel):
    ...
    svciProtocol: Optional[str] = None
    svciPortNum: Optional[str] = None
    svciTargetPort: Optional[str] = None
