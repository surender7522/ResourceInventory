...
#   filename:  ThresholdMonitor.json
...
class ThresholdMonitor(BaseModel):
    ...
    thmonMonitorGranularityPeriod: Optional[str] = None
    thmonObjectInstances: Optional[str] = None
    thmonRootObjectInstances: Optional[str] = None
