...
class ThresholdInfo(BaseModel):
    ...
    thinfoThresholdLevel: Optional[str] = None
    thinfoThresholdDirection: Optional[str] = None
    thinfoThresholdValue: Optional[str] = None
    thinfoHysteresis: Optional[str] = None
