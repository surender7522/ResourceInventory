...
#   filename:  SliceProfile.json
#   timestamp: 2023-04-25T03:55:47+00:00
...
class SliceProfile(BaseModel):
    ...
    sprofSNSSAIList: Optional[str] = None
    sprofPLMNIdList: Optional[str] = None
    sprofMaxNumberofUEs: Optional[str] = None
    sprofCoverageAreaTAList: Optional[str] = None
    sprofLatency: Optional[str] = None
    sprofUEMobilityLevel: Optional[str] = None
    sprofResourceSharingLevel: Optional[str] = None
