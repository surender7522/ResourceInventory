...
#   filename:  CNF.json
#   timestamp: 2023-04-25T03:55:40+00:00
...
class CNF(BaseModel):
    ...
    cnfNfUid: Optional[str] = None
    cnfdName: Optional[str] = None
    cnfAppClusterid: Optional[str] = None
    cnfNodeid: Optional[str] = None
    cnfNvnodes: Optional[str] = None
    cnfSequenceNumber: Optional[str] = None
    cnfENBId: Optional[str] = None
    cnfDay1Status: Optional[str] = None
    cnfE2EOClusterRegistrationId: Optional[str] = None
    cnfDescriptorId: Optional[str] = None
    cnfDescriptorName: Optional[str] = None
    cnfDescriptorVersion: Optional[str] = None
    cnfTenantId: Optional[str] = None
    cnfTenantName: Optional[str] = None
    cnfUtime: Optional[str] = None
    cnfIPSubnet: Optional[str] = None
